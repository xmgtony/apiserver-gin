...
基于gin的api服务端脚手架。 gin在Go web开发中是相当受欢迎的，但是gin也是一个轻量级web框架，并不能像其他语言比如java的spring框架具有统一标准和完善生态，在实际开发中需要自己设计和添加一些能力，比如：request_id透传，依赖注入，日志打印分割，session管理，全局错误处理，打包编译等等。
